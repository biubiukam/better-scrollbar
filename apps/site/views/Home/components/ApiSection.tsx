					...
					<Table>
						<TableHeader>
							<TableRow className="bg-secondary/52 hover:bg-secondary/52">
								<TableHead className="min-w-[168px] text-foreground">
									{copy.apiHeaders.name}
								</TableHead>
								<TableHead className="min-w-[320px] text-foreground">
									{copy.apiHeaders.description}
								</TableHead>
								<TableHead className="min-w-[280px] text-foreground">
									{copy.apiHeaders.type}
								</TableHead>
								<TableHead className="min-w-[150px] text-foreground">
									{copy.apiHeaders.defaultValue}
								</TableHead>
							</TableRow>
						</TableHeader>
						<TableBody>
