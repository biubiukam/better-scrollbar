...
import type { ItemsRenderedInfo, ScrollState } from "@better-scrollbar/react"
...
export function getToneChannel(scrollState: ScrollState) {
	return Math.round(
		getScrollProgressRatio(scrollState.y, scrollState.scrollHeight, scrollState.clientHeight) *
			255
	)
}
