...
export const demoTw = {
	shell: "flex w-full flex-col bg-card text-card-foreground",
	...
	listTall: "h-[360px] shrink-0 border-b border-border",
	toolbar:
		"flex flex-wrap items-center gap-2 border-t border-border bg-card px-3.5 py-2.5 text-xs text-muted-foreground",
	...
	buttonDanger:
		"h-6 rounded-md border border-destructive/35 bg-card px-2 text-xs text-destructive hover:bg-destructive/10",
	control:
		"h-8 w-full rounded-md border border-border bg-card px-2.5 text-xs leading-4 text-card-foreground",
	row: "flex w-full items-center justify-between gap-3 border-t border-border bg-card px-3.5 text-[13px] text-muted-foreground",
	gridRow:
		"grid w-full items-center gap-2.5 border-t border-border bg-card px-3.5 text-[13px] text-muted-foreground",
...
export const caseTw = {
	...
	toolbar:
		"flex min-h-[42px] shrink-0 items-center gap-2 overflow-x-auto border-b border-border bg-muted/25 px-3 py-2",
	...
	groupRow:
		"border-l-[3px] border-l-success bg-success text-success-foreground [&_*]:text-success-foreground",
