...
export const HOME_API_PROPS: Record<LocaleMode, HomeApiPropRow[]> = {
	en: [
		...
		{
			name: "style",
			description: "Inline style for the outer container.",
			type: "CSSProperties",
			defaultValue: "-"
		},
		{
			name: "className",
			description: "Class name for the outer container.",
			type: "string",
			defaultValue: "-"
		},
		{
			name: "isVirtual",
			description: "Enable virtual rendering.",
			type: "boolean",
			defaultValue: "true"
		},
		{
			name: "itemCount",
			description:
				"Total indexed item count. Use this for huge lists without building a children array.",
			type: "number",
			defaultValue: "children.length"
		},
		{
			name: "renderItem",
			description: "Lazy renderer used with itemCount.",
			type: "(index: number) => ReactElement",
			defaultValue: "-"
		},
		{
			name: "itemKey",
			description: "Stable key generator for indexed items.",
			type: "(index: number) => Key",
			defaultValue: "index"
		},
		{
			name: "estimatedItemHeight",
			description: "Estimated height for unmeasured rows. Used for virtual range estimation.",
			type: "number",
			defaultValue: "20"
		},
		{
			name: "overscan",
			description:
				"Extra item count or full overscan config (items, pixels, adaptive) rendered outside the visible range.",
			type: "number | OverscanConfig",
			defaultValue: "1"
		},
		{
			name: "scrollSeek",
			description: "Render lightweight placeholders while scrolling fast.",
			type: "boolean | ScrollSeekOptions",
			defaultValue: "false"
		},
		{
			name: "maintainVisibleContentPosition",
			description: "Keep the current visible item anchored when data or measurements change.",
			type: "boolean",
			defaultValue: "true"
		},
		{
			name: "followOutput",
			description:
				"Stay pinned to the bottom when data is appended. Pass true or { threshold } for custom threshold.",
			type: "boolean | FollowOutputOptions",
			defaultValue: "false"
		},
		{
			name: "stickyIndices",
			description:
				"Always-sticky item indexes, commonly used for group headers. Use getStickyIndicesFromGroups() for grouped lists.",
			type: "number[]",
			defaultValue: "-"
		},
		{
			name: "onScroll",
			description: "Fires with the full scroll state when scrolling changes.",
			type: "(scrollState: ScrollState) => void",
			defaultValue: "-"
		},
		{
			name: "onScrollStart",
			description: "Fires when scrolling starts.",
			type: "() => void",
			defaultValue: "-"
		},
		{
			name: "onScrollEnd",
			description: "Fires when scrolling ends.",
			type: "() => void",
			defaultValue: "-"
		},
		{
			name: "onItemsRendered",
			description: "Fires when the rendered and visible item ranges change.",
			type: "(info: ItemsRenderedInfo) => void",
			defaultValue: "-"
		},
		{
			name: "prefixCls",
		...
		},
		{
			...
			description: "Hide custom scrollbars.",
			type: "boolean",
			defaultValue: "false"
		},
		{
			name: "scrollBarAutoHideTimeout",
			description: "Delay before auto-hiding the scrollbar.",
			type: "number",
			defaultValue: "1000"
		},
		{
			name: "renderView",
			description: "Custom render function for the scroll view.",
			type: "RenderElement<HTMLProps<HTMLDivElement>>",
			defaultValue: "renderViewDefault"
		},
		{
			name: "renderTrackHorizontal",
			description: "Custom render function for the horizontal track.",
			type: "RenderElement<HTMLProps<HTMLDivElement>>",
			defaultValue: "renderTrackHorizontalDefault"
		},
		{
			name: "renderTrackVertical",
			description: "Custom render function for the vertical track.",
			type: "RenderElement<HTMLProps<HTMLDivElement>>",
			defaultValue: "renderTrackVerticalDefault"
		},
		{
			name: "renderThumbHorizontal",
			description: "Custom render function for the horizontal thumb.",
			type: "RenderElement<HTMLProps<HTMLDivElement>>",
			defaultValue: "renderThumbHorizontalDefault"
		},
		{
			name: "renderThumbVertical",
			description: "Custom render function for the vertical thumb.",
			type: "RenderElement<HTMLProps<HTMLDivElement>>",
			defaultValue: "renderThumbVerticalDefault"
		}
	],
	zh: [
		...
		{
			name: "itemCount",
			description: "按索引渲染的数据总数，适合超大列表避免创建完整 children 数组。",
			type: "number",
			defaultValue: "children.length"
		},
		{
			name: "renderItem",
			description: "与 itemCount 配合使用的惰性渲染函数。",
			type: "(index: number) => ReactElement",
			defaultValue: "-"
		},
		{
			name: "itemKey",
			description: "按索引生成稳定 key。",
			type: "(index: number) => Key",
			defaultValue: "index"
		},
		{
			name: "estimatedItemHeight",
			description: "未测量行的预估高度，用于虚拟区间估算。",
			type: "number",
			defaultValue: "20"
		},
		{
			name: "overscan",
			description:
				"可视区外额外渲染的条目数量，或完整 overscan 配置（items、pixels、adaptive）。",
			type: "number | OverscanConfig",
			defaultValue: "1"
		},
		{
			name: "scrollSeek",
			description: "高速滚动时使用轻量占位项，降低重行渲染成本。",
			type: "boolean | ScrollSeekOptions",
			defaultValue: "false"
		},
		{
			name: "maintainVisibleContentPosition",
			description: "数据或测量变化时保持当前可见条目锚定。",
			type: "boolean",
			defaultValue: "true"
		},
		{
			name: "followOutput",
			description:
				"已在底部附近时，追加数据后继续贴住底部。传 true 或 { threshold } 自定义阈值。",
			type: "boolean | FollowOutputOptions",
			defaultValue: "false"
		},
		{
			name: "stickyIndices",
			description:
				"始终吸顶的条目索引，常用于分组头。可配合 getStickyIndicesFromGroups() 使用。",
			type: "number[]",
			defaultValue: "-"
		},
		{
			name: "onScroll",
			description: "滚动状态变化时触发。",
			type: "(scrollState: ScrollState) => void",
			defaultValue: "-"
		},
		{
		...
		{
			name: "scrollBarHidden",
			description: "是否隐藏自定义滚动条。",
			type: "boolean",
			defaultValue: "false"
		},
		{
			name: "scrollBarAutoHideTimeout",
			description: "滚动条自动隐藏延迟。",
			type: "number",
			defaultValue: "1000"
		},
		{
			name: "renderView",
			description: "自定义滚动视图渲染函数。",
			type: "RenderElement<HTMLProps<HTMLDivElement>>",
			defaultValue: "renderViewDefault"
		},
		{
			name: "renderTrackHorizontal",
			description: "自定义水平滚动轨渲染函数。",
			type: "RenderElement<HTMLProps<HTMLDivElement>>",
			defaultValue: "renderTrackHorizontalDefault"
		},
		{
			name: "renderTrackVertical",
			description: "自定义垂直滚动轨渲染函数。",
			type: "RenderElement<HTMLProps<HTMLDivElement>>",
			defaultValue: "renderTrackVerticalDefault"
		},
		{
			name: "renderThumbHorizontal",
			description: "自定义水平滚动滑块渲染函数。",
			type: "RenderElement<HTMLProps<HTMLDivElement>>",
			defaultValue: "renderThumbHorizontalDefault"
		},
		{
			name: "renderThumbVertical",
			description: "自定义垂直滚动滑块渲染函数。",
			type: "RenderElement<HTMLProps<HTMLDivElement>>",
			defaultValue: "renderThumbVerticalDefault"
		}
	]
...
export const HOME_COPY: Record<LocaleMode, HomeCopy> = {
	...
	zh: {
		...
		casesDesc: "规模、测量、变更和产品壳各占一张卡，用真实交互说明能力。",
		playgroundTitle: "场景实验台",
		playgroundDesc: "在同一份 1 亿行数据上组合预设和 props，下方就是实际组件工作流。",
		demosTitle: "场景 Demo 工作台",
		demosDesc: "一次聚焦一个产品场景，保持原有演示节奏，同时让每个场景承载多项滚动能力。",
